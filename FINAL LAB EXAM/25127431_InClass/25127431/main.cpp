...
void main2() {
	AssaultBot assaultBot1(1);
	AssaultBot assaultBot2(2);
	SniperBot sniperBot1(1);

	BotSquad squad1(1);
	squad1.addBot(&assaultBot1);
	squad1.addBot(&assaultBot2);

	MechaLegion legion1;
	legion1.addLegion(&squad1);
	legion1.addLegion(&sniperBot1);

	BotSquad squad2(2);
	squad2.addBot(&sniperBot1);
	MechaLegion legion2;
	legion2.addLegion(&squad2);

	legion1.addLegion(&legion2);
	legion1.draw();

	cout << "\n" << legion1.getCombatRating() << "\n";
}
using namespace std;
int main() {
	main2();
